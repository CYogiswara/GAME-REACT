    ...
    return (
        <>
            ...
            {isGameOver ? (
                ...
                <div className="france-root">
                    <div className={`black-screen${showBlackScreen ? " show" : ""}`} id="blackScreen"></div>
                    <div className="frame">
                        <div className="camera">
                            <div className="france-map pixel-art" style={mapStyle}>
                                <div>
                                    ...
                                    <DisplayDate />
                                    <button style={{ position: "absolute", top: 20, right: 1000, zIndex: 1000, padding: "8px 16px", background: speed === 3 ? "#4caf50" : "#2196f3", color: "#fff", border: "none", borderRadius: 4, cursor: "pointer" }} onClick={toggleSpeed} > Speed: {speed}x </button>
                                    ...
                                    {showFoods && (
                                        <div id="makanOptions" className="france-makan-options">
